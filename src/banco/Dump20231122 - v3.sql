CREATE DATABASE  IF NOT EXISTS `LabTech` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `LabTech`;
...
INSERT INTO `cliente` VALUES (1,'João Silva','123.456.789-00','12345-678','joao@email.com','senha123'),(2,'Maria Santos','987.654.321-00','98765-432','maria@email.com','senha456'),(3,'Carlos Oliveira','111.222.333-00','11111-222','carlos@email.com','senha789'),(4,'evandromariano','162.175.633-55','11111111','evan@gmail.com','scrypt:32768:8:1$gGc1VEWDZlbbLH4q$ba1468426c458b282d6798e551514ff678a3f5b9d66f3d93eedb444fa891fe38789fcd38bb95a1a3392c6c5f2b8520ff3c5f17700fc59147aa448f54cfdd8429');
...
INSERT INTO `pedido` VALUES (1,0,3,8,55.39,443.12,10.00,453.12,0),(2,0,3,8,55.39,443.12,10.00,453.12,0);
...
CREATE TABLE `pedido_has_produto` (
  ...
  PRIMARY KEY (`pedido_id`,`pedido_cliente_idcliente`,`produto_idproduto`),
  KEY `fk_pedido_has_produto_produto1_idx` (`produto_idproduto`),
  KEY `fk_pedido_has_produto_pedido1_idx` (`pedido_id`,`pedido_cliente_idcliente`),
  CONSTRAINT `fk_pedido_has_produto_pedido1` FOREIGN KEY (`pedido_id`, `pedido_cliente_idcliente`) REFERENCES `pedido` (`id`, `cliente_idcliente`),
...
-- Dump completed on 2023-11-22  0:26:22
